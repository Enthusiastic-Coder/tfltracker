...
ScrollablePage {
    ...
    Component.onCompleted: {
        ...
        cppGlue.onLineStatusUpdate.connect(incomingData)
        obj.refresh()
    }

    Component.onDestruction: cppGlue.onLineStatusUpdate.disconnect(incomingData)
    ...
    ColumnLayout {
        QtObject {
            ...
            function refresh() {
                ...
                cppGlue.updateStatusForLines(mode, lines)
            }
